 ...
 */
public class RecyclerHeaderFooterAdapterWrapper
    ...
    private int mRefreshProgressStyle =
            LoadingIndicatorView.RecyclerLoaderAnimator.PROGRESSSTYLE.SysProgress;

    private ActivityRecycler.RecyclerRefreshHeader mRefreshHeader;
    ...
    /**
     * RecyclerView的核心Adapter,实现列表中Item数据的适配
     */
    ...
    private ActivityRecycler.OnItemClickLitener mOnItemClickLitener;
    ...
    public RecyclerHeaderFooterAdapterWrapper(Context context, RecyclerView.Adapter innerAdapter) {
        mContext = context;
        setRefreshHeader();
        setListContentAdapter(innerAdapter);
    }

    public void setRefreshHeader() {
        if (pullRefreshEnabled) {

            ActivityRecycler.RecyclerRefreshHeader refreshHeader =
                    new ActivityRecycler.RecyclerRefreshHeader(mContext);
    ...
    public ActivityRecycler.RecyclerRefreshHeader getRefreshHeader() {
     ...
     * @param adapter
     */
    public void setListContentAdapter(RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        ...
        int realDatasCount;
        if (mInnerAdapter != null) {
            realDatasCount = mInnerAdapter.getItemCount();
            if (adjPosition < realDatasCount) {
    ...
    public long getItemId(int position) {
        if (mInnerAdapter != null && position >= getHeaderViewsCount()) {
            ...
            int realDatasCount = mInnerAdapter.getItemCount();
            if (adjPosition < realDatasCount) {
    ...
    public void setOnItemClickLitener(ActivityRecycler.OnItemClickLitener mOnItemClickLitener) {
